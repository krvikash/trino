...
Register table
--------------
The connector can register table into the metastore with existing metadata and data files.

An SQL procedure ``system.register_table`` allows the caller to register a new table
