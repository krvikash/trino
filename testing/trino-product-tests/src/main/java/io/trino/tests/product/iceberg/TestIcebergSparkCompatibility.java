        ...
        extends ProductTest
{
            ...
            throws TException
    {
        ...
        String describeSparkNewTable = (String) onSpark().executeQuery("DESCRIBE TABLE EXTENDED " + sparkTableName).getOnlyValue();
        String showCreateTrinoNewTable = (String) onTrino().executeQuery("SHOW CREATE TABLE " + trinoTableName).getOnlyValue();
