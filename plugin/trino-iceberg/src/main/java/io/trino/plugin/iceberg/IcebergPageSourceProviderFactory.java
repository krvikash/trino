        ...
        implements ConnectorPageSourceProviderFactory
{
            ...
            TypeManager typeManager)
    {
        ...
        this.outputDateTimeZone = icebergConfig.getOutputDateTimeZone();
    ...
    {
        return new IcebergPageSourceProvider(fileSystemFactory, fileFormatDataSourceStats, orcReaderOptions, parquetReaderOptions, outputDateTimeZone, typeManager);
    }
}
