    ...
    public void registerTable(ConnectorSession clientSession, String schemaName, String tableName, String tableLocation, String metadataFileName)
    {
        ...
        try (ThreadContextClassLoader ignored = new ThreadContextClassLoader(classLoader)) {
            doRegisterTable(
                    ...
                    Optional.ofNullable(tableLocation),
                    Optional.ofNullable(metadataFileName));
        }
    }

    private void doRegisterTable(ConnectorSession clientSession, Optional<String> schemaName, Optional<String> tableName, Optional<String> tableLocation, Optional<String> metadataFileName)
    {
        if (!(schemaName.isPresent() && tableName.isPresent() && tableLocation.isPresent())) {
            throw new TrinoException(
                    IcebergErrorCode.ICEBERG_INVALID_METADATA,
        ...
        catalog.registerTable(clientSession, schemaTableName, tableLocation.get(), metadataFileName.orElse(null));
    }
}
