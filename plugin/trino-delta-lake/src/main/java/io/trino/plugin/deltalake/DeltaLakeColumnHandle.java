        ...
        implements ColumnHandle
{
    ...
    public int hashCode()
    {
        return Objects.hash(baseColumnName, baseType, fieldId, basePhysicalColumnName, basePhysicalType, columnType, projectionInfo);
    }
    ...
    {
        Optional<HiveColumnProjectionInfo> hiveColumnProjectionInfo = projectionInfo.map(DeltaLakeColumnProjectionInfo::toHiveColumnProjectionInfo);
