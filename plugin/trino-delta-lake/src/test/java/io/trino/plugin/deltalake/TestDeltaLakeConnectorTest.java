        ...
        extends BaseConnectorTest
{
    ...
    public void testProjectionPushdownReadsLessData()
    {
        ...
        assertUpdate(
                format("INSERT INTO " + tableName + " VALUES (1, ROW('%s', 3)), (11, ROW('%1$s', 13)), (21, ROW('%1$s', 23)), (31, ROW('%1$s', 33))", largeVarchar),
                4);
        ...
        assertQueryStats(
                ...
                selectQuery,
                statsWithPushdown -> {
                    DataSize processedDataSizeWithPushdown = statsWithPushdown.getPhysicalInputDataSize();
                    assertQueryStats(
                            sessionWithoutPushdown,
                            selectQuery,
                            statsWithoutPushdown -> assertThat(statsWithoutPushdown.getPhysicalInputDataSize()).isGreaterThan(processedDataSizeWithPushdown),
    ...
    @Test
    public void testProjectionPushdownNonPrimtiveTypeExplain()
    {
